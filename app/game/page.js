  ...
  return (
    ...
    <div className="fixed inset-0 bg-black flex justify-center z-40">
      <div className="w-full max-w-md h-full flex flex-col bg-gray-950 text-white font-sans relative overflow-hidden">
        ...
        <main className={(activeTab === 'enhance' || activeTab === 'inventory') ? "flex-1 flex flex-col min-h-0 relative z-10 p-2 pb-[160px] overflow-y-auto" : "flex-1 overflow-y-auto min-h-0 relative z-10 p-2 pb-[175px]"}>
          {activeTab === 'enhance' && (
        ...
        <nav className="absolute bottom-[95px] left-0 right-0 h-[65px] bg-gray-900 border-t border-gray-800 flex z-50">
