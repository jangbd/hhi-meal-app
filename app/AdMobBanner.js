...
import { USE_TEST_ADS, TEST_AD_IDS } from './featureFlags';
...
const ADMOB_BANNER_ID = USE_TEST_ADS
  ? TEST_AD_IDS.banner[PLATFORM === 'ios' ? 'ios' : 'android']
  : (PLATFORM === 'ios' ? 'ca-app-pub-1252871302557543/8548467606' : 'ca-app-pub-1252871302557543/4251623238');
