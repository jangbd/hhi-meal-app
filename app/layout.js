  ...
  return (
    <html lang="ko">
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="HD현대 식단 앱" />
      ...
      <body className="bg-slate-100 antialiased" style={{ fontFamily: 'Pretendard, -apple-system, BlinkMacSystemFont, system-ui, Roboto, sans-serif' }}>
        ...
        <div className="max-w-md mx-auto min-h-screen bg-white shadow-2xl relative" style={{ paddingBottom: 'calc(var(--ad-clearance) + env(safe-area-inset-bottom) + 15px)' }}>
          {children}
